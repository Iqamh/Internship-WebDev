                                    ...
                                    <div class="row">
                                        <div class="col col-12">
                                            <div class="form-group">
                                                <label for="first-name-column">Nama<span class="text-danger">*</span></label>
                                                <input type="text" id="first-name-column" class="form-control" placeholder="Nama Lengkap" name="nama" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="city-column">NIM/NIS<span class="text-danger">*</span></label>
                                                <input type="text" id="city-column" class="form-control" placeholder="1456286412" name="nim" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="email-id-column" class="form-control" name="surat" placeholder="Nomor Surat Rekomendasi" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
